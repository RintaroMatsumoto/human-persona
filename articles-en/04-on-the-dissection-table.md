...
emoji: "🔬"
type: "idea"
topics: ["AI", "metamorphosis", "research diary", "ablation"]
published: false
---
...
notes: Mean Alignment 0.945, Distribution Alignment 0.864 verified in benchmarks/results/ablation_results.json (run date 2026-03-25T03:22:24Z, seed=42, eval_size=500). Also certified as real data in CLAUDE.md. Contribution percentages for each step are also backed by the same JSON.
-->