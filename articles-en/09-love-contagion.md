...
emoji: "🦠"
type: "tech"
topics: ["AI", "Metamorphosis", "Research Diary", "Social Simulation"]
published: false
---
...
notes: Experiment 7 (social propagation) is based on sim_society.py, Experiment 7b (anti-love) on sim_antilove.py, and Experiment 6c (gradient acceptance) on sim_gradient_acceptance.py execution results. The conclusion of critical mass at 4 individuals is consistent with simulation results. Published in V1 preprint (DOI:10.5281/zenodo.19273577).
-->